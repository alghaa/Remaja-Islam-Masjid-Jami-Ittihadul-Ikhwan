...
const state = {
  ...
  players: [
    { Nama: 'Alif', umur: 20, jabatan: 'Pelatih Kepala' },
    { Nama: 'Stella', umur: 19, jabatan: 'Asisten Pelatih'},
    { Nama: 'Husen', umur: 16, jabatan: 'Kiper' },
    { Nama: 'Raihan', umur: 16, jabatan: 'Anchor' },
    { Nama: 'Andi', umur: 16, jabatan: 'Anchor' },
